...
class Test_Salman:
    ...
    # update the job terminate details    
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators.job).click()
       sleep(2) 
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().terminate).click()
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().terminate_date).send_keys(Data.Salman_Data().terminate_date)
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().terminate_reason).click()
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().terminate_reason).send_keys(Data.Salman_Data().terminate_reason)
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().terminate_reason).send_keys(Keys.ENTER)
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().save_5).click()
       sleep(8)
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().Active_emp).click()
       
# validate the updated job terminate details   
       self.driver.execute_script("window.scrollBy(0,2000)","")
       sleep(5)
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().Active_emp).click()
       sleep(3)
