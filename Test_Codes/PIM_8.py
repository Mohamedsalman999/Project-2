...
class Test_Salman:
    ...
    # update the dependents details    
       ...
       sleep(2)
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators.Add_1).click()
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().Dep_name).send_keys(Data.Salman_Data().Dep_name)
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().Dep_rlt).click()
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().Dep_rlt).send_keys(Data.Salman_Data().enter_o)
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().Dep_rlt).send_keys(Keys.ENTER)
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().Specify).send_keys(Data.Salman_Data().Specify)
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().DOB_1).send_keys(Data.Salman_Data().DOB_1)
       self.driver.find_element(by=By.XPATH, value=Locators.Salman_Locators().save_3).click()
       sleep(5)
